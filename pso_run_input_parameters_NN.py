...
Noof_swarms=3               # number of swarms in the search
Noof_threads=5
...
search_dim=2								
verbose='y'				
sync_step=1     ## at this step they swarms will sync g_best
Ninj=50   ## Number of injections
...
save_snr_plot='y'
save_step_data='n'
over_write='n'        ## This is output directory!	
